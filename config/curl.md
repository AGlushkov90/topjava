...
#### change Active
``curl --location 'http://localhost:80/topjava/rest/admin/users/change-active' \--header 'Content-Type: application/json' \ --header 'Authorization: Basic YWRtaW5AZ21haWwuY29tOmFkbWlu' \ --data '{"id":100000, "active":false}'``
