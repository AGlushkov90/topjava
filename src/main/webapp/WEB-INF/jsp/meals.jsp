...
<div class="jumbotron pt-4">
    <div class="container">
        ...
        <%--            </dl>--%>
        <div>
            <button type="submit" onclick="updateTableWithFilter()"><spring:message code="meal.filter"/></button>
            <button type="submit" onclick="resetFilter()"><spring:message code="meal.reset"/></button>
        </div>
