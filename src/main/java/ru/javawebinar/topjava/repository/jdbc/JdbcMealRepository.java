...
public class JdbcMealRepository implements MealRepository {
    ...
    public JdbcMealRepository(JdbcTemplate jdbcTemplate, NamedParameterJdbcTemplate namedParameterJdbcTemplate, ValidatorFactory validatorFactory) {
    ...
    public Meal save(Meal meal, int userId) {
        ...
        Set<ConstraintViolation<Object>> constraintViolations = validator.validate(meal);
